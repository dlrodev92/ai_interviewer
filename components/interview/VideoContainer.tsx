...
export default function VideoContainer({
  ...
  const [speaking, setSpeaking] = useState<'interviewer' | 'candidate' | null>(
    null
  );
    ...
    <>
      ...
      >
        ...
        <div className="inset-0 mt-10 p-4 grid grid-cols-2 gap-4">
          {/* AI Interviewer */}
          <div
            className={`relative transition-all duration-300 ${speaking === 'interviewer' ? 'ring-2 ring-primary' : ''}`}
          >
          ...
          {/* Candidate */}
          <div
            className={`relative transition-all duration-300 ${speaking === 'candidate' ? 'ring-2 ring-primary' : ''}`}
          >
        ...
        <AlertDialogContent className="bg-zinc-900 border-zinc-700">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-zinc-400">
              You've already used one interview token for this session. Ending
              the interview early will not refund your token.
              <br />
              <br />
